...
function renderExpenses(expenses) {
  ...
  function handleEdit(event) {
    ...
    // Remove expense from the array and update the rendered expenses
  ...
  function handleDelete(event) {
    ...
    axios.delete(`https://crudcrud.com/api/c181d00adee547d1b9a946ebccac23e9/expenses/${id}`)
      .then(response => {
        console.log(response.data); // Check the response data for confirmation
  ...
  function fetchExpenses() {
    axios.get('https://crudcrud.com/api/c181d00adee547d1b9a946ebccac23e9/expenses')
      .then(response => {
